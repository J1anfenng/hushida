...
const locations: Location[] = [
  ...
  // { name: '木兰公寓', coords: [28.19005, 112.94135], description: '湖南师范大学木兰公寓' },
  // { name: '研六舍', coords: [28.18935, 112.94075], description: '湖南师范大学研六舍' },
  // { name: '研二舍', coords: [28.18815, 112.94135], description: '湖南师范大学研二舍' },
  // { name: '研五舍', coords: [28.18950, 112.94208], description: '湖南师范大学研五舍' },
  // { name: '研三舍', coords: [28.18865, 112.94208], description: '湖南师范大学研三舍' },
  // { name: '至善楼', coords: [28.18765, 112.94208], description: '湖南师范大学至善楼' },
  // { name: '服装设计系', coords: [28.18615, 112.94148], description: '湖南师范大学服装设计系' },
  // { name: '理仁楼', coords: [28.18565, 112.94078], description: '湖南师范大学理仁楼' },
  // { name: '研一舍', coords: [28.18765, 112.94138], description: '湖南师范大学研一舍' },
  // { name: '外国语学院', coords: [28.1905, 112.94110], description: '湖南师范大学外国语学院' },
  // { name: '高师楼', coords: [28.1903, 112.94226], description: '湖南师范大学高师楼' },
  // { name: '图书馆', coords: [28.1895, 112.94335], description: '湖南师范大学逸夫图书馆' },
  // { name: '景德楼', coords: [28.1932, 112.94100], description: '湖南师范大学景德楼' },
  // { name: '忠烈祠', coords: [28.1926, 112.94025], description: '忠烈祠' },
  // { name: '岳王亭', coords: [28.19247, 112.93953], description: '岳王亭' },
  // { name: '经纬楼', coords: [28.1927, 112.94213], description: '湖南师范大学经纬楼' },
  // { name: '研究生院', coords: [28.19362, 112.94248], description: '湖南师范大学研究生院' },
  // { name: '红楼', coords: [28.19455, 112.94170], description: '湖南师范大学红楼' },
  // { name: '新闻与传播学院', coords: [28.19345, 112.94315], description: '湖南师范大学新闻与传播学院' },
  // { name: '二里半宿舍', coords: [28.19305, 112.94435], description: '湖南师范大学二里半宿舍' },
  // { name: '生命科学学院', coords: [28.19225, 112.94500], description: '湖南师范大学生命科学学院' },
  // { name: '教务处', coords: [28.19205, 112.9398], description: '湖南师范大学教务处' },
  // { name: '研五舍', coords: [28.19215, 112.94035], description: '湖南师范大学研五舍' },
  // { name: '文渊楼', coords: [28.1920, 112.9416], description: '湖南师范大学文渊楼' },
  // { name: '校工会', coords: [28.19165, 112.94243], description: '湖南师范大学校工会' },
  // { name: '中和楼', coords: [28.1911, 112.9419], description: '湖南师范大学中和楼' },
  // { name: '化工院', coords: [28.1912, 112.9432], description: '湖南师范大学化工院' },
  // { name: '江湾体育馆', coords: [28.18805, 112.9435], description: '湖南师范大学江湾体育馆' },
  // { name: '工学院', coords: [28.18805, 112.9443], description: '湖南师范大学工学院' },
  // { name: '理学院', coords: [28.18705, 112.94497], description: '湖南师范大学理学院' },
  // { name: '国际学术报告厅', coords: [28.18675, 112.94492], description: '湖南师范大学国际学术报告厅' },
  // { name: '田径场', coords: [28.18813, 112.94713], description: '湖南师范大学田径场' },
  // { name: '江边一舍', coords: [28.18880, 112.9484], description: '湖南师范大学江边一舍' },
  // { name: '江边二舍', coords: [28.18933, 112.9484], description: '湖南师范大学江边二舍' },
  // { name: '江边三舍', coords: [28.18990, 112.9485], description: '湖南师范大学江边三舍' },
  // { name: '江边食堂', coords: [28.19045, 112.9487], description: '湖南师范大学江边食堂' },
